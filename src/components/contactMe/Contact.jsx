...
const Contact = () => {
  ...
  const sendEmail = (e) => {  
    ...
    emailjs
    .sendForm('service_0xqsybe', 'template_i8awil9', form.current, 'MSXzhQVtnxLpM_YNL')
    .then(
      (result) => {
      ...
      <div className="container contact__container">
        <div className="contact__options">
          ...
          <article className="contact__option">
            ...
            <h4>Whatsapp</h4>
            <a href="https://api.whatsapp.com/send?phone=6289678249846" target="__blank">Send A Message</a>
          </article>
        </div>
